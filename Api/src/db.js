...
const { User, ShoppingCart, Article, Category, Review, Size, Cart_Articule, Article_Size } = sequelize.models;
...
Article.belongsToMany(Size, { through: Article_Size });
Size.belongsToMany(Article, { through: Article_Size });

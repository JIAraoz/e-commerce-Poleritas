...
export default function Products() {
	...
	useEffect(() => {
		...
		async function fetchProducts(page) {
			...
			try {
				console.log(
					`URL de solicitud: https://e-commerce-grupo03.onrender.com/article/articles?page=${page}&limit=${productsPerPage}&category=${query.filter}&order=${query.order}&name=${query.search}`,
				);
			...
			<div className='filters'>
				<div className='custom-select'>
					...
					<div className='right-filters'>
						...
						<button className='ApplyFilters' onClick={handleFilters}>
							Apply filters
						</button>
					</div>
				</div>
